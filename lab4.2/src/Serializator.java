...
public class Serializator {
    public boolean serialization(Client s, String fileName) {
        boolean flag = false;
    ...
    public Client deserialization(String fileName) throws InvalidObjectException {
        ...
        try {
            ...
            // десериализация
            Client st = (Client) istream.readObject();
            return st;
